...
def sum_of_products_with_sqrt_pairs(left: Tuple[Coordinate, Coordinate],
                                    right: Tuple[Coordinate, Coordinate]
                                    ) -> Coordinate:
    """
...
def sum_of_products_with_sqrt_triplets(
...
def to_constant(value: Coordinate,
                _zero: Expression = to_sqrt(0)) -> Expression:
    return _zero + value
